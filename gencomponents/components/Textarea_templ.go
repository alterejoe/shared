...
func textareaBase(props *structs.Textarea, bgClass string, borderClass string, textClass string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		if props.ID != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `Textarea.templ`, Line: 7, Col: 16}
			}
		...
		if props.Name != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `Textarea.templ`, Line: 10, Col: 20}
			}
		...
		if props.FormBehaviors.ConstraintString() != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `Textarea.templ`, Line: 29, Col: 59}
			}
		...
		if props.FormBehaviors.DirtyGroup != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `Textarea.templ`, Line: 35, Col: 52}
			}
		...
		if props.Hx.Method == structs.GET {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `Textarea.templ`, Line: 38, Col: 24}
			}
		...
		if props.Hx.Method == structs.POST {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `Textarea.templ`, Line: 41, Col: 25}
			}
		...
		if props.Hx.Method == structs.PUT {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `Textarea.templ`, Line: 44, Col: 24}
			}
		...
		if props.Hx.Method == structs.DELETE {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `Textarea.templ`, Line: 47, Col: 27}
			}
		...
		if props.Hx.Trigger != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `Textarea.templ`, Line: 50, Col: 32}
			}
		...
		if props.Hx.Target != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `Textarea.templ`, Line: 53, Col: 30}
			}
		...
		if props.Hx.Swap != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `Textarea.templ`, Line: 56, Col: 26}
			}
		...
		if props.Hx.Vals != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `Textarea.templ`, Line: 59, Col: 26}
			}
		...
		if props.Hx.Include != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `Textarea.templ`, Line: 62, Col: 32}
			}
		...
		if props.Hx.Indicator != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `Textarea.templ`, Line: 65, Col: 36}
			}
		...
		if props.Hx.Confirm != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `Textarea.templ`, Line: 68, Col: 32}
			}
		...
		if props.Hx.PushURL != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `Textarea.templ`, Line: 71, Col: 33}
			}
		...
		if templ_7745c5c3_Err != nil {
			return templ.Error{Err: templ_7745c5c3_Err, FileName: `Textarea.templ`, Line: 73, Col: 15}
		}
		...
		if props.ID != "" {
			...
			if templ_7745c5c3_Err != nil {
				return templ.Error{Err: templ_7745c5c3_Err, FileName: `Textarea.templ`, Line: 75, Col: 32}
			}
