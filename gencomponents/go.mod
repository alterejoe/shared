module github.com/alterejoe/shared/gencomponents
...
require (
	...
	github.com/alterejoe/shared/structs v0.0.0-20260105030754-0f48f6f7e840 // indirect
...
replace github.com/alterejoe/shared/create => ../create/
